      ...
      <>
       <View style={[style.wrapper, wrapperStyle]}>
        ...
        {labelVisible && (touched || score !== 0) && score < 70
          ? <View style={{height: 50}}><Text style={[style.label, { color: '#828282'}]}>Your password is easily guessed. Try making your password longer. Combine uppercase and lowercase letters. Add special characters.</Text></View>
          : null
        }
      </View>
      </>
